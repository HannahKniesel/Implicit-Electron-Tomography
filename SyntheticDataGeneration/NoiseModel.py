...
class CondMLPRadial1DFlow(torch.nn.Module):
    ...
    def __init__(self, num_hidden=8, additional_hidden=False, kaiming_relu = False):
    ...
    def __init__(self, 
        ...
        for i in range(num_layers_cond):
            if cond_type == "conv":
              ...
              self.cond_flow_layers.append(
                CondMLPRadial1DFlow(num_hidden_cond, additional_hidden = additional_hidden, kaiming_relu = kaiming_relu))              
